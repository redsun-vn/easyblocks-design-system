...
var index$1 = require('./index-8160a594.js');
var index$2 = require('./index-004169c7.js');
var index$3 = require('./index-d3e89138.js');
...
var TooltipTrigger$1 = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    const composedRefs = index.useComposedRefs(forwardedRef, ref, context.onTriggerChange);
...
var TooltipPortal = (props) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(PortalProvider, { scope: __scopeTooltip, forceMount, children: /* @__PURE__ */ jsxRuntime.jsx(index$2.Presence, { present: forceMount || context.open, children: /* @__PURE__ */ jsxRuntime.jsx(index$1.Portal, { asChild: true, container, children }) }) });
};
...
var TooltipContent$1 = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(index$2.Presence, { present: forceMount || context.open, children: context.disableHoverableContent ? /* @__PURE__ */ jsxRuntime.jsx(TooltipContentImpl, { side, ...contentProps, ref: forwardedRef }) : /* @__PURE__ */ jsxRuntime.jsx(TooltipContentHoverable, { side, ...contentProps, ref: forwardedRef }) });
  }
);
      ...
      index$1.DismissableLayer,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs(
          index$1.Content,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(index.Slottable, { children }),
              /* @__PURE__ */ jsxRuntime.jsx(VisuallyHiddenContentContextProvider, { scope: __scopeTooltip, isInside: true, children: /* @__PURE__ */ jsxRuntime.jsx(index$3.Root, { id: context.contentId, role: "tooltip", children: ariaLabel || children }) })
            ]
          }
        )
      }
...
function Tooltip(props) {
  return /*#__PURE__*/React__default["default"].createElement(Root3, null, props.children);
}
...
function TooltipContent(props) {
  return /*#__PURE__*/React__default["default"].createElement(Portal, null, /*#__PURE__*/React__default["default"].createElement(Content2, {
    style: {
      display: "flex",
      padding: "6px 8px",
  ...
  }, /*#__PURE__*/React__default["default"].createElement(Arrow2, {
    style: {

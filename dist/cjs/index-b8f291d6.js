...
var index = require('./index-85b0d5d4.js');
var index$1 = require('./index-72b8d470.js');
var index$2 = require('./index-e3f5c538.js');
...
var FocusScope = React__namespace.forwardRef((props, forwardedRef) => {
  ...
  const composedRefs = index.useComposedRefs(forwardedRef, (node) => setContainer(node));
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(index.Primitive.div, { tabIndex: -1, ...scopeProps, ref: composedRefs, onKeyDown: handleKeyDown });
});
...
var BubbleSelect = React__namespace.forwardRef(
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(index$2.VisuallyHidden, { asChild: true, children: /* @__PURE__ */ jsxRuntime.jsx("select", { ...selectProps, ref: composedRefs, defaultValue: value }) });
  }
);

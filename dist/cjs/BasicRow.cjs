...
const TextContainer = styled.styled.div.withConfig({
...
const DescriptionContainer = styled.styled.div.withConfig({
...
const EditContainer = styled.styled.div.withConfig({

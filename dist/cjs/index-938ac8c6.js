...
var index = require('./index-72b8d470.js');
    ...
    RovingFocusProvider,
    {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx(
        index$1.Primitive.div,
        {
          ...
          onMouseDown: index$1.composeEventHandlers(props.onMouseDown, () => {
            isClickFocusRef.current = true;
          }),
          onFocus: index$1.composeEventHandlers(props.onFocus, (event) => {
          ...
          onBlur: index$1.composeEventHandlers(props.onBlur, () => setIsTabbingBackOut(false))
        }
      )
    }
  );
      ...
      Collection.ItemSlot,
      {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(
          index$1.Primitive.span,
          {
            ...
            ...itemProps,
            ref: forwardedRef,
            onMouseDown: index$1.composeEventHandlers(props.onMouseDown, (event) => {
              if (!focusable) event.preventDefault();
              else context.onItemFocus(id);
            }),
            onFocus: index$1.composeEventHandlers(props.onFocus, () => context.onItemFocus(id)),

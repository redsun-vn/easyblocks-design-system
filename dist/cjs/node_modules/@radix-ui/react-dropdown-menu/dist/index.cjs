...
var index$5 = require('../../react-use-controllable-state/dist/index.cjs');
var index$2 = require('../../react-primitive/dist/index.cjs');
var index$1 = require('../../react-menu/dist/index.cjs');
var index$6 = require('../../react-id/dist/index.cjs');
...
var DropdownMenu = (props) => {
  ...
  const [open = false, setOpen] = index$5.useControllableState({
    prop: openProp,
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    DropdownMenuProvider,
    {
      ...
      triggerId: index$6.useId(),
      triggerRef,
      contentId: index$6.useId(),
      open,
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(index$1.Anchor, { asChild: true, ...menuScope, children: /* @__PURE__ */ jsxRuntime.jsx(
      index$2.Primitive.button,
      {
        ...
        disabled,
        ...triggerProps,
        ref: index$3.composeRefs(forwardedRef, context.triggerRef),
  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      index$1.Content,
      {
        ...
        ...contentProps,
        ref: forwardedRef,
        onCloseAutoFocus: index$4.composeEventHandlers(props.onCloseAutoFocus, (event) => {
          if (!hasInteractedOutsideRef.current) context.triggerRef.current?.focus();
          hasInteractedOutsideRef.current = false;
          event.preventDefault();
        }),
        onInteractOutside: index$4.composeEventHandlers(props.onInteractOutside, (event) => {

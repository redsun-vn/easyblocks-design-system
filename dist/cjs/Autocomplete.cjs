...
var use$2 = React__namespace[" use ".trim().toString()];
...
var use$1 = React__namespace[" use ".trim().toString()];
...
var useLayoutEffect2$2 = globalThis?.document ? React__namespace.useLayoutEffect : () => {
};
...
const Shell = styled.styled.div.withConfig({
  displayName: "styles__Shell",
  componentId: "sc-ylfdk5-0"
})(["position:relative;display:flex;align-items:center;gap:4px;box-sizing:border-box;width:100%;min-height:28px;padding:4px 6px;border-radius:2px;background:", ";color:", ";box-shadow:0 0 0 1px ", ";transition:box-shadow 0.1s;cursor:", ";", ";&:hover{box-shadow:0 0 0 1px ", ";}&:focus-within{box-shadow:0 0 0 2px ", ";}"], colors.Colors.white, p => p.$disabled ? colors.Colors.black40 : colors.Colors.black800, p => p.$hasError ? colors.Colors.red : colors.Colors.black10, p => p.$disabled ? "not-allowed" : "text", fonts.Fonts.body, p => p.$hasError ? colors.Colors.red : colors.Colors.black20, p => p.$hasError ? colors.Colors.red : colors.Colors.focus);

/** Holds chips (multiple) and the text input; wraps to multiple lines. */
const ValueArea = styled.styled.div.withConfig({
...
const InputEl = styled.styled.input.withConfig({
  displayName: "styles__InputEl",
  componentId: "sc-ylfdk5-2"
})(["all:unset;flex:1 1 auto;min-width:30px;max-width:120px;box-sizing:border-box;color:inherit;", ";&::placeholder{color:", ";}&:disabled{cursor:not-allowed;}"], fonts.Fonts.body, colors.Colors.black40);

/** Right-aligned cluster: spinner, clear button, dropdown toggle. */
const EndAdornments = styled.styled.div.withConfig({
...
})(["all:unset;display:inline-flex;align-items:center;justify-content:center;box-sizing:border-box;color:", ";border-radius:2px;cursor:pointer;&:hover{color:", ";}&:focus-visible{box-shadow:0 0 0 2px ", ";}&:disabled{cursor:not-allowed;opacity:0.5;}"], colors.Colors.black40, colors.Colors.black800, colors.Colors.focus);

/** Dropdown surface (rendered inside Radix Popper.Content). */
const Listbox = styled.styled.ul.withConfig({
  displayName: "styles__Listbox",
  componentId: "sc-ylfdk5-5"
})(["margin:0;padding:4px 0;list-style:none;box-sizing:border-box;max-height:240px;overflow-y:auto;background:", ";border-radius:2px;box-shadow:0 0 0 1px ", ",0 4px 12px ", ";width:var(--radix-popper-anchor-width);min-width:var(--radix-popper-anchor-width);z-index:1000;", ";&:focus{outline:none;}"], colors.Colors.white, colors.Colors.black10, colors.Colors.black10, fonts.Fonts.body);

/** A single selectable option row. */
const OptionItem = styled.styled.li.withConfig({
  displayName: "styles__OptionItem",
  componentId: "sc-ylfdk5-6"
})(["display:flex;align-items:center;gap:6px;padding:6px 10px;color:", ";cursor:pointer;font-weight:", ";background:", ";"], colors.Colors.black800, p => p.$selected ? 600 : 400, p => p.$highlighted ? colors.Colors.black5 : "transparent");

/** Non-selectable informational row (loading / empty). */
const StateRow = styled.styled.li.withConfig({
  displayName: "styles__StateRow",
  componentId: "sc-ylfdk5-7"
})(["display:flex;align-items:center;justify-content:center;gap:6px;padding:10px;color:", ";cursor:default;"], colors.Colors.black40);
...
function AutocompleteListbox(props) {
  ...
  return (
    ...
    React__default["default"].createElement(Portal, {
      style: {
        position: "absolute",
        zIndex: 100000
      }
    ...
    }, /*#__PURE__*/React__default["default"].createElement(Listbox, menuProps, loading ? /*#__PURE__*/React__default["default"].createElement(StateRow, {
      "aria-disabled": true,
      role: "presentation"
    }, /*#__PURE__*/React__default["default"].createElement(icons.Icons.LoadingSpinner, {
      size: 16
    }), loadingText) : items.length === 0 ? /*#__PURE__*/React__default["default"].createElement(StateRow, {
      "aria-disabled": true,
      role: "presentation"
    }, noOptionsText) : items.map((item, index) => {
      const selected = isItemSelected ? isItemSelected(item) : false;
      const highlighted = highlightedIndex === index;
      return /*#__PURE__*/React__default["default"].createElement(OptionItem, _rollupPluginBabelHelpers._extends({
...
function SingleAutocomplete(props) {
  ...
  const filtered = React.useMemo(() => getFilteredOptions({
    options,
    inputValue,
    getOptionLabel,
    filterOptions
  }), [options, inputValue, getOptionLabel, filterOptions]);
  const combobox = downshift.useCombobox({
    items: filtered,
    inputValue,
    selectedItem,
    ...
    onInputValueChange: _ref => {
      ...
      const v = next ?? "";
      setInputValue(v);
      const isUserTyping = type === downshift.useCombobox.stateChangeTypes.InputChange;
  ...
  return /*#__PURE__*/React__default["default"].createElement(Root2, null, /*#__PURE__*/React__default["default"].createElement(Anchor, {
    asChild: true
  }, /*#__PURE__*/React__default["default"].createElement(Shell, {
    $disabled: disabled,
    className: className
  }, /*#__PURE__*/React__default["default"].createElement(ValueArea, null, renderInput ? renderInput({
    inputProps,
    disabled,
    placeholder
  }) : /*#__PURE__*/React__default["default"].createElement(InputEl, inputProps)), /*#__PURE__*/React__default["default"].createElement(EndAdornments, null, showClear && /*#__PURE__*/React__default["default"].createElement(IconButton, {
    type: "button",
    "aria-label": "Clear",
    disabled: disabled,
    onClick: handleClear
    ...
    size: 14
  })), /*#__PURE__*/React__default["default"].createElement(IconButton, _rollupPluginBabelHelpers._extends({
    type: "button",
    ...
    size: 16
  }))))), /*#__PURE__*/React__default["default"].createElement(AutocompleteListbox, {
    isOpen: isOpen,
    items: filtered,
...
const ChipRoot = styled.styled.div.withConfig({
  displayName: "autocomplete-chip__ChipRoot",
  componentId: "sc-5tnk6y-0"
})(["display:inline-flex;align-items:center;gap:4px;box-sizing:border-box;max-width:100%;padding:1px 4px 1px 6px;border-radius:2px;background:", ";color:", ";", ";"], colors.Colors.black5, colors.Colors.black800, fonts.Fonts.body);
const ChipLabel = styled.styled.span.withConfig({
  displayName: "autocomplete-chip__ChipLabel",
  componentId: "sc-5tnk6y-1"
})(["overflow:hidden;white-space:nowrap;text-overflow:ellipsis;"]);
const ChipRemove = styled.styled.button.withConfig({
  displayName: "autocomplete-chip__ChipRemove",
  componentId: "sc-5tnk6y-2"
})(["all:unset;display:inline-flex;align-items:center;color:", ";border-radius:2px;cursor:pointer;&:hover{color:", ";}&:focus-visible{box-shadow:0 0 0 2px ", ";}"], colors.Colors.black40, colors.Colors.black800, colors.Colors.focus);
function AutocompleteChip(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement(ChipRoot, selectedItemProps, /*#__PURE__*/React__default["default"].createElement(ChipLabel, null, label), !disabled && /*#__PURE__*/React__default["default"].createElement(ChipRemove, {
    type: "button",
...
function MultipleAutocomplete(props) {
  ...
  const multipleSelection = downshift.useMultipleSelection({
    ...(isControlled ? {
      selectedItems: value ?? []
    } : {
    ...
    onStateChange: _ref => {
      ...
      if (!next) return;
      const t = downshift.useMultipleSelection.stateChangeTypes;
  ...
  const available = React.useMemo(() => getFilteredOptions({
    options,
    inputValue,
    getOptionLabel,
    filterOptions
  ...
  return /*#__PURE__*/React__default["default"].createElement(Root2, null, /*#__PURE__*/React__default["default"].createElement(Anchor, {
    ...
    $disabled: disabled,
    className: className
  }, /*#__PURE__*/React__default["default"].createElement(ValueArea, null, visibleChips.map((item, index) => /*#__PURE__*/React__default["default"].createElement(AutocompleteChip, {
    key: `${getOptionLabel(item)}-${index}`,
  ...
  })), hiddenCount > 0 && /*#__PURE__*/React__default["default"].createElement("span", null, `+${hiddenCount}`), renderInput ? renderInput({
    inputProps,
    disabled,
    placeholder
  }) : /*#__PURE__*/React__default["default"].createElement(InputEl, inputProps)), /*#__PURE__*/React__default["default"].createElement(EndAdornments, null, /*#__PURE__*/React__default["default"].createElement(IconButton, _rollupPluginBabelHelpers._extends({
    type: "button",
    "aria-label": "Toggle options"
  }, getToggleButtonProps({
    disabled
...
function AutocompleteInner(props, ref) {
  if (props.multiple) {
    return /*#__PURE__*/React__default["default"].createElement(MultipleAutocomplete, _rollupPluginBabelHelpers._extends({}, props, {
      forwardedRef: ref
    }));
  }
  return /*#__PURE__*/React__default["default"].createElement(SingleAutocomplete, _rollupPluginBabelHelpers._extends({}, props, {
    forwardedRef: ref
  }));
}

...
})(["all:unset;flex:1 1 auto;min-width:30px;box-sizing:border-box;color:inherit;", ";&::placeholder{color:", ";}&:disabled{cursor:not-allowed;}"], fonts.Fonts.body, colors.Colors.black40);

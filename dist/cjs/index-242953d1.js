  ...
  (props, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      index.Primitive.div,
      {
        ...
        onFocusCapture: index.composeEventHandlers(props.onFocusCapture, focusOutside.onFocusCapture),
        onBlurCapture: index.composeEventHandlers(props.onBlurCapture, focusOutside.onBlurCapture),
        onPointerDownCapture: index.composeEventHandlers(
...
var DismissableLayerBranch = React__namespace.forwardRef((props, forwardedRef) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(index.Primitive.div, { ...props, ref: composedRefs });
});
...
function handleAndDispatchCustomEvent(name, handler, detail, { discrete }) {
  ...
  if (discrete) {
    index.dispatchDiscreteCustomEvent(target, event);
  } else {
